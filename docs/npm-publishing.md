...
- GitHub release `v0.38.0` is public with attached `agentloopkit-0.38.0.tgz`.
...
- Release tag `v0.38.0` points at the published release commit.
- GitHub Marketplace publication remains deferred until maintainer approval for the owner-only listing step.

The `0.38.0` release completed through GitHub release automation, npm trusted publishing, Docker/GHCR, and MCP Registry. The GitHub Marketplace URL still returned 404 during post-release proof.
