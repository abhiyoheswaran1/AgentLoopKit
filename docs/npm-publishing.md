...
- GitHub release URL: `https://github.com/abhiyoheswaran1/AgentLoopKit/releases/tag/v0.27.0`.
- GitHub release tarball SHA-256: `7ff6cb0b2079da83b6cc1cad2b59485337338167388ce1deae01f0752f98f3e0`.
- npm trusted publishing is configured for `abhiyoheswaran1/AgentLoopKit` and `.github/workflows/publish.yml`.
- GitHub release `v0.27.0` published to npm through trusted publishing.
...
- `agentloopkit@0.24.5` added the packed release smoke script and refreshed the README VHS demo.
- Local tarball SHA-256 before GitHub release: `202454e639170968e5e45ea6a68ebf560111749b63380fa379c8c91ea8ac2253`.
- GitHub release URL: `https://github.com/abhiyoheswaran1/AgentLoopKit/releases/tag/v0.24.5`.
- GitHub release tarball SHA-256: `202454e639170968e5e45ea6a68ebf560111749b63380fa379c8c91ea8ac2253`.
- GitHub Publish workflow run `27277913836` for `v0.24.5` passed package checks and published to npm through trusted publishing.
- npm registry proof after the `v0.24.5` publish reports latest `0.24.5` and versions `0.1.0`, `0.1.1`, `0.24.0`, `0.24.1`, `0.24.2`, `0.24.3`, `0.24.4`, and `0.24.5`.
- `agentloopkit@0.25.0` added `agentloop init --local-only`.
- Local tarball SHA-256 before GitHub release: `f39669cf62ec5a455bad788223040dd0a0c65dcb86665cf6086f04a84d9ff427`.
...
- `agentloopkit@0.26.0` added the read-only MCP server, MCP Registry metadata, GitHub Action wrapper, and Docker/GHCR workflow.
...
- Local tarball SHA-256 before GitHub release: `48bc379e41293cbcbc74facbf111548a307fb1bf3a179a0a08121cd2aa4c9c85`.
- GitHub release URL: `https://github.com/abhiyoheswaran1/AgentLoopKit/releases/tag/v0.26.3`.
- GitHub release tarball SHA-256: `48bc379e41293cbcbc74facbf111548a307fb1bf3a179a0a08121cd2aa4c9c85`.
- GitHub Publish workflow run `27294103749` for `v0.26.3` passed package checks and published to npm through trusted publishing.
- Docker workflow run `27294103779` for `v0.26.3` passed and published the GHCR image.
- MCP Registry workflow run `27294196815` for `v0.26.3` passed and published registry metadata.
- npm registry proof after the `v0.26.3` publish reports latest `0.26.3` and versions through `0.26.3`.
- `agentloopkit@0.26.4` added SchemaStore editor discovery documentation and refreshed package-facing release-channel pins.
- Local tarball SHA-256 before GitHub release: `a8ede1d0710d67b40fa80c1045e7cfda93afe32525c29f46997617cc6f17fbfa`.
- GitHub release URL: `https://github.com/abhiyoheswaran1/AgentLoopKit/releases/tag/v0.26.4`.
- GitHub release tarball SHA-256: `a8ede1d0710d67b40fa80c1045e7cfda93afe32525c29f46997617cc6f17fbfa`.
- GitHub Publish workflow run `27296379647` for `v0.26.4` passed package checks and published to npm through trusted publishing.
- Docker workflow run `27296379642` for `v0.26.4` passed and published the GHCR image.
- MCP Registry workflow run `27296470988` for `v0.26.4` passed and published registry metadata.
- npm registry proof after the `v0.26.4` publish reports latest `0.26.4` and versions through `0.26.4`.
...
- Local tarball SHA-256 before GitHub release: `64fe8d8bc6c64b0d5699b85dbc962d64c6d2423b2ac01b13aad537f75cd0edc8`.
- GitHub release URL: `https://github.com/abhiyoheswaran1/AgentLoopKit/releases/tag/v0.26.5`.
- GitHub release tarball SHA-256: `64fe8d8bc6c64b0d5699b85dbc962d64c6d2423b2ac01b13aad537f75cd0edc8`.
- GitHub Publish workflow run `27298446341` for `v0.26.5` passed package checks and published to npm through trusted publishing.
- Docker workflow run `27298446331` for `v0.26.5` passed and published the GHCR image.
- MCP Registry workflow run `27298526436` for `v0.26.5` passed and published registry metadata.
- npm registry proof after the `v0.26.5` publish reports latest `0.26.5` and versions through `0.26.5`.
- `agentloopkit@0.27.0` added `agentloop task doctor`, a read-only task folder hygiene diagnostic.
- Local tarball SHA-256 before GitHub release: `7ff6cb0b2079da83b6cc1cad2b59485337338167388ce1deae01f0752f98f3e0`.
- GitHub release URL: `https://github.com/abhiyoheswaran1/AgentLoopKit/releases/tag/v0.27.0`.
- GitHub release tarball SHA-256: `7ff6cb0b2079da83b6cc1cad2b59485337338167388ce1deae01f0752f98f3e0`.
- GitHub Publish workflow run `27300950330` for `v0.27.0` passed package checks and published to npm through trusted publishing.
- Docker workflow run `27300951486` for `v0.27.0` passed and published the GHCR image.
- MCP Registry workflow run `27301046893` for `v0.27.0` passed and published registry metadata.
- npm registry proof after the `v0.27.0` publish reports latest `0.27.0` and versions through `0.27.0`.
