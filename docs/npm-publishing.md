...
- npm latest is `agentloopkit@0.28.5`.
- GitHub release `v0.28.5` is public with attached `agentloopkit-0.28.5.tgz`.
...
The `0.28.5` release completed through GitHub release automation, npm trusted publishing, Docker/GHCR, MCP Registry, and published-package smoke checks.
