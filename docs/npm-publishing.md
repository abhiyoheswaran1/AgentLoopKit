...
- GitHub release `v0.43.0` is public with attached `agentloopkit-0.43.0.tgz`.
...
The `0.43.0` release completed through GitHub release automation, npm trusted publishing, Docker/GHCR, and MCP Registry. The GitHub Marketplace URL still returned 404 during post-release proof.
