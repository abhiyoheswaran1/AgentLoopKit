...
`agentloop check-gates --strict` is in the `v0.14.0` GitHub release. npm still serves `agentloopkit@0.1.1` until publishing auth is repaired.
...
```bash
npm install --no-save https://github.com/abhiyoheswaran1/AgentLoopKit/releases/download/v0.14.0/agentloopkit-0.14.0.tgz
