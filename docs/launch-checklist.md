...
- [ ] GitHub release `v0.18.1` is published with policy-customization guidance release notes.
...
- `agentloopkit@0.18.1` is prepared on `main` for policy customization guidance.
