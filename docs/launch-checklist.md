...
- [ ] GitHub release `v0.15.0` is published with npm-pending notes.
...
- [ ] Publish workflow for `v0.15.0` passes package checks.
...
- `agentloopkit@0.15.0` is prepared on `main` for CI context in verification reports.
