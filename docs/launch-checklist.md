...
- [ ] GitHub release `v0.12.0` is published with npm-pending notes.
...
- [ ] Publish workflow for `v0.12.0` passes checks.
...
- `agentloopkit@0.12.0` is prepared on `main` for `create-task --json`.
