      ...
      (
        await runAgentLoop(
          [
            ...
            '--acceptance',
            '`node task-command-output.mjs` exits 0 on every supported CI OS.',
            '--verify-command',
      ...
      (
        await runAgentLoop(
          [
            ...
            'node_modules/ (installed dependencies)',
            '--acceptance',
            '`node --version` resolves the root AgentLoopKit workspace from a nested directory.',
            '--verify-command',
            'node --version',
            '--rollback',
            'Delete the temporary nested smoke directory.',
            '--json',
          ],
          { cwd: nestedDir },
        )
