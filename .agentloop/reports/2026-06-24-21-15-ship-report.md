...
- Handoff: `.agentloop/handoffs/2026-06-24-21-15-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `66 non-evidence changed files is broad for one review; 169 AgentLoop evidence file(s) also present (235 total). Non-evidence review areas: Source 29, Documentation 14, AgentLoop 12, Tests 11.`
...
- Evidence map: `235` changed file(s); `66` covered, `0` unexplained; verification `fresh`; `0` risk-sensitive.
...
- AgentLoop evidence: `169` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
...
- [`pass`] `Git context`: `236 changed file(s) detected (66 non-evidence, 170 AgentLoop evidence).`
