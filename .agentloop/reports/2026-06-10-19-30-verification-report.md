...
- Timestamp: 2026-06-10T17:30:41.051Z
- Repo: AgentLoopKit
- Git branch: main
- Git commit: 9e9763d
- Working tree: dirty
...
> vitest run
 ...
 Test Files  33 passed (33)
   ...
   Start at  19:30:42
   Duration  10.93s (transform 1.38s, setup 0ms, import 5.10s, tests 86.50s, environment 8ms)
...
Markdown links OK (614 file(s) checked).
```
...
> agentloopkit@0.26.3 smoke:release
> node scripts/smoke-packed-release.mjs

Release smoke for agentloopkit@0.26.3
Packed /var/folders/tc/vn86wd6d7v70rn_pxbv3h2k40000gn/T/agentloopkit-release-smoke-u5o1ro/pack/agentloopkit-0.26.3.tgz
...
> agentloopkit@0.26.3 prepublishOnly
> node scripts/prepublish-check.mjs && npm run typecheck && npm test && npm run build

Prepublish metadata check passed.

> agentloopkit@0.26.3 typecheck
> tsc --noEmit


> agentloopkit@0.26.3 test
> vitest run
 ...
 Test Files  33 passed (33)
      Tests  146 passed (146)
   Start at  19:31:13
   Duration  11.29s (transform 1.48s, setup 0ms, import 5.91s, tests 91.16s, environment 6ms)


> agentloopkit@0.26.3 build
> tsup && node scripts/copy-assets.mjs
...
DTS dist/cli/index.d.ts 13.00 B
npm notice
npm notice 📦  agentloopkit@0.26.3
npm notice Tarball Contents
npm notice 1.1kB LICENSE
npm notice 25.3kB README.md
...
npm notice version: 0.26.3
npm notice filename: agentloopkit-0.26.3.tgz
npm notice package size: 122.1 kB
npm notice unpacked size: 536.6 kB
npm notice shasum: a7a8934a49f9a5a40e21b3dae0b64147c62127e1
npm notice integrity: sha512-SzOGEQ7NHdGDu[...]IizgC2p0nnLmQ==
