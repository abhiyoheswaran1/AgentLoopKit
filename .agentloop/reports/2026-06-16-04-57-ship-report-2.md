...
- Handoff: `.agentloop/handoffs/2026-06-16-04-57-pr-summary-5.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `48 changed files is broad for one review.`
...
- [`pass`] `Git context`: `49 changed file(s) detected.`
