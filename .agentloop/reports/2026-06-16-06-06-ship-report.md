...
- Task: `Make badge output Markdown-safe` (`done`) - `.agentloop/tasks/archive/2026-06-16-make-badge-output-markdown-safe.md`
- Verification: `pass` - `.agentloop/reports/2026-06-16-06-03-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-16-06-06-pr-summary-3.md`
- Gates: `pass`
...
- [`pass`] `Task contract`: `Make badge output Markdown-safe`
