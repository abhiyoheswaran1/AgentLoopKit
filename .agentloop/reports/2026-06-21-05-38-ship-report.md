...
- Generated: `2026-06-21-05-38`
- Review readiness score: `92`/100
- Task: `Document safe AgentFlight verify command syntax` (`in-progress`) - `.agentloop/tasks/2026-06-21-document-safe-agentflight-verify-command-syntax.md`
- Verification: `pass` - `.agentloop/reports/2026-06-21-05-37-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-21-05-38-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `90 non-evidence changed files is broad for one review; 294 AgentLoop evidence file(s) also present (384 total).`
...
- AgentLoop evidence: `294` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
- Full paths remain in JSON output and run-ledger evidence.

## Diff Stat

```text
.agentloop/backlog.md                         | 123 ++++++++++
 ...
 65 files changed, 1860 insertions(+), 216 deletions(-)
...
- [`pass`] `Task contract`: `Document safe AgentFlight verify command syntax`
- [`pass`] `Verification report`: `Overall status: pass`
- [`pass`] `Handoff summary`: `Reviewer handoff found.`
- [`pass`] `Task hygiene`: `Task folder hygiene checks passed.`
- [`pass`] `Repo harness`: `Required repo and harness files exist.`
- [`pass`] `Safety policies`: `Core safety policy files exist.`
- [`pass`] `Git context`: `385 changed file(s) detected (90 non-evidence, 295 AgentLoop evidence).`
