...
- Generated: `2026-06-17-13-25`
- Review readiness score: `92`/100
- Task: `Add built CLI smoke coverage for latest ship report artifacts` (`in-progress`) - `.agentloop/tasks/2026-06-17-add-built-cli-smoke-coverage-for-latest-ship-report-artifacts-2.md`
- Verification: `pass` - `.agentloop/reports/2026-06-17-13-16-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-17-13-25-pr-summary-2.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `105 non-evidence changed files is broad for one review; 2775 AgentLoop evidence file(s) also present (2880 total).`
...
- AgentLoop evidence: `2775` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
...
.agentflight/config.json                           |    6 +-
 ...
 90 files changed, 9394 insertions(+), 774 deletions(-)
```

## Gate Summary

- [`pass`] `Task contract`: `Add built CLI smoke coverage for latest ship report artifacts`
- [`pass`] `Verification report`: `Overall status: pass`
- [`pass`] `Handoff summary`: `Reviewer handoff found.`
- [`pass`] `Task hygiene`: `Task folder hygiene checks passed.`
- [`pass`] `Repo harness`: `Required repo and harness files exist.`
- [`pass`] `Safety policies`: `Core safety policy files exist.`
- [`pass`] `Git context`: `2881 changed file(s) detected (105 non-evidence, 2776 AgentLoop evidence).`
