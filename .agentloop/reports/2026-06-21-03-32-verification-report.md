...
- Timestamp: `2026-06-21T01:32:26.256Z`
- Repo: `AgentLoopKit`
- Git branch: `main`
- Git commit: `32aec524`
- Working tree: `dirty`
...
## Task Context
- Path: `.agentloop/tasks/2026-06-21-show-task-risk-notes-in-ship-reports.md`
- Title: `Show task risk notes in ship reports`
- Task type: `feature`
- Status: `in-progress`
...
> vitest run tests/ship.test.ts
 ...
 Test Files  1 passed (1)
      Tests  16 passed (16)
   Start at  03:32:31
   Duration  134.40s (transform 106ms, setup 0ms, import 177ms, tests 133.84s, environment 0ms)
...
Markdown links OK (4596 file(s) checked).
```
