...
- Handoff: `.agentloop/handoffs/2026-06-28-00-58-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `32 non-evidence changed files is broad for one review; 5 AgentLoop evidence file(s) also present (37 total). Non-evidence review areas: Source 15, Documentation 7, Tests 5, AgentLoop 4, Config / Package 1.`
...
- Evidence map: `37` changed file(s); `32` covered, `0` unexplained; verification `fresh`; `0` risk-sensitive.
...
.agentloop/README.md                             |  6 ++-
 ...
 24 files changed, 244 insertions(+), 28 deletions(-)
...
- [`pass`] `Git context`: `38 changed file(s) detected (32 non-evidence, 6 AgentLoop evidence).`
