...
- Timestamp: `2026-06-16T06:47:54.874Z`
- Repo: `AgentLoopKit`
- Git branch: `main`
- Git commit: `a79cc41`
- Working tree: `dirty`
...
> vitest run tests/agent-installation.test.ts
 ...
 Test Files  1 passed (1)
      Tests  13 passed (13)
   Start at  08:47:55
   Duration  4.64s (transform 60ms, setup 0ms, import 103ms, tests 4.39s, environment 0ms)
...
> vitest run tests/agent-installation.test.ts tests/cli-docs-drift.test.ts
 ...
 Test Files  2 passed (2)
      Tests  14 passed (14)
   Start at  08:48:00
   Duration  4.89s (transform 115ms, setup 0ms, import 218ms, tests 5.30s, environment 0ms)
