...
- Generated: `2026-06-21-06-39`
- Review readiness score: `92`/100
- Task: `Omit exact covered commands from verification Not Run` (`in-progress`) - `.agentloop/tasks/2026-06-21-omit-exact-covered-commands-from-verification-not-run.md`
- Verification: `pass` - `.agentloop/reports/2026-06-21-06-36-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-21-06-39-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `98 non-evidence changed files is broad for one review; 326 AgentLoop evidence file(s) also present (424 total). Non-evidence review areas: AgentLoop 32, Source 32, Tests 21, Documentation 10, CI / Automation 2, Config / Package 1.`
...
- AgentLoop evidence: `326` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
- Full paths remain in JSON output and run-ledger evidence.

## Diff Stat

```text
.agentloop/backlog.md                         | 141 +++++++++++
 ...
 70 files changed, 2079 insertions(+), 277 deletions(-)
...
- [`pass`] `Task contract`: `Omit exact covered commands from verification Not Run`
- [`pass`] `Verification report`: `Overall status: pass`
- [`pass`] `Handoff summary`: `Reviewer handoff found.`
- [`pass`] `Task hygiene`: `Task folder hygiene checks passed.`
- [`pass`] `Repo harness`: `Required repo and harness files exist.`
- [`pass`] `Safety policies`: `Core safety policy files exist.`
- [`pass`] `Git context`: `425 changed file(s) detected (98 non-evidence, 327 AgentLoop evidence).`
