...
- Timestamp: `2026-06-29T07:49:34.440Z`
- Repo: `AgentLoopKit`
- Git branch: `main`
- Git commit: `758ccce1`
- Working tree: `dirty`
...
## Task Context
- Path: `.agentloop/tasks/2026-06-29-release-agentloopkit-0-47-0.md`
- Title: `Release AgentLoopKit 0.47.0`
- Task type: `release`
- Status: `in-progress`
...
> agentloopkit@0.47.0 release-flow
...
> agentloopkit@0.47.0 test:release
> npm test


> agentloopkit@0.47.0 test
> vitest run
 ...
 Test Files  74 passed (74)
   ...
   Start at  09:49:47
   Duration  1183.71s (transform 1.13s, setup 0ms, import 5.98s, tests 4681.53s, environment 7ms)
...
Markdown links OK (5379 file(s) checked).

> agentloopkit@0.47.0 dogfood
...
AgentLoopKit: task="Release AgentLoopKit 0.47.0" status="in-progress"; verification=missing; run="handoff 47 files"; tree=dirty (60; 32 non-evidence, 28 AgentLoop evidence); next="agentloop verify"
...
[output truncated: showing first 2500 and last 2500 characters of 14888 total]
...
> agentloopkit@0.47.0 smoke:release
> node scripts/smoke-packed-release.mjs

Release smoke for agentloopkit@0.47.0
Packed /var/folders/tc/vn86wd6d7v70rn_pxbv3h2k40000gn/T/agentloopkit-release-smoke-l42JGj/pack/agentloopkit-0.47.0.tgz
