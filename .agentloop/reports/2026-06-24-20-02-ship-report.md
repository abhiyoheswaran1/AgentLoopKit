...
- Generated: `2026-06-24-20-02`
- Review readiness score: `92`/100
- Task: `Bound MCP handoff listing work` (`in-progress`) - `.agentloop/tasks/2026-06-24-bound-mcp-handoff-listing-work.md`
- Verification: `pass` - `.agentloop/reports/2026-06-24-20-01-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-24-20-02-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `59 non-evidence changed files is broad for one review; 84 AgentLoop evidence file(s) also present (143 total). Non-evidence review areas: Source 25, Documentation 14, AgentLoop 12, Tests 8.`
...
- Evidence map: `143` changed file(s); `59` covered, `0` unexplained; verification `fresh`; `0` risk-sensitive.
...
- AgentLoop evidence: `84` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
...
.agentloop/README.md                               |   6 +
 ...
 53 files changed, 1938 insertions(+), 191 deletions(-)
...
- [`pass`] `Git context`: `144 changed file(s) detected (59 non-evidence, 85 AgentLoop evidence).`
