...
- Timestamp: `2026-06-17T11:16:06.765Z`
- Repo: `AgentLoopKit`
- Git branch: `main`
- Git commit: `370a9fe`
- Working tree: `dirty`
...
## Task Context
- Path: `.agentloop/tasks/2026-06-17-add-built-cli-smoke-coverage-for-latest-ship-report-artifacts-2.md`
- Title: `Add built CLI smoke coverage for latest ship report artifacts`
- Task type: `tests`
- Status: `in-progress`
...
> vitest run
 ...
 Test Files  63 passed (63)
   ...
   Start at  13:16:09
   Duration  269.60s (transform 902ms, setup 0ms, import 4.72s, tests 2620.84s, environment 5ms)
...
### task: `npm test -- tests/distribution-artifacts.test.ts -t "latest ship report"`
...
> vitest run tests/distribution-artifacts.test.ts -t latest ship report
 ...
 Test Files  1 passed (1)
   ...
   Start at  13:21:01
   Duration  258ms (transform 36ms, setup 0ms, import 47ms, tests 3ms, environment 0ms)
...
> vitest run tests/distribution-artifacts.test.ts
 ...
 Test Files  1 passed (1)
      Tests  53 passed (53)
   Start at  13:21:04
   Duration  440ms (transform 59ms, setup 0ms, import 88ms, tests 97ms, environment 0ms)
...
AgentLoopKit: task="Add built CLI smoke coverage for latest ship report artifacts" status="in-progress"; verification=pass; run="ship 92/100"; tree=dirty (2872; 105 non-evidence, 2767 AgentLoop evidence); next="agentloop task done"
...
This command reads local AgentLoopKit harness files only. It does not overwrite guidance, merge templates, run verification commands, read .env contents, call external APIs, or upload file

[output truncated: showing first 2500 and last 2500 characters of 9508 total]

ress`) - `.agentloop/tasks/2026-06-17-add-built-cli-smoke-coverage-for-latest-ship-report-artifacts-2.md`
- Latest verification: `pass` - `.agentloop/reports/2026-06-17-13-16-verification-report.md`
- Gates: `pass`
- Policy status: `8` current, `0` modified, `0` missing, `0` extra
- Artifacts: `3` task(s), `114` AgentFlight placeholder task(s), `541` verification report(s), `899` handoff(s)
- Latest ship score: `92`/100 - `.agentloop/reports/2026-06-17-13-12-ship-report.md`
- GitHub metadata: missing - `.agentloop/github/context.json`
- Working tree: `dirty (2872; 105 non-evidence, 2767 AgentLoop evidence)`

## Recent Runs

- `ship` `92`/100 - `2860` changed file(s) (`105` non-evidence, `2755` AgentLoop evidence) - `2026-06-17-13-12-ship`
- `handoff` `2855` changed file(s) (`105` non-evidence, `2750` AgentLoop evidence) - `2026-06-17-13-12-handoff`
- `verify` `pass` - `2852` changed file(s) (`105` non-evidence, `2747` AgentLoop evidence) - `2026-06-17-13-09-verify`
