...
- Timestamp: 2026-06-10T18:42:17.492Z
- Repo: AgentLoopKit
- Git branch: main
- Git commit: 1547d64
- Working tree: dirty
...
## Task Context
- Path: .agentloop/tasks/2026-06-10-prepare-0-26-5-terminal-fallback-release.md
- Title: Prepare 0.26.5 terminal fallback release
- Task type: release
- Status: in-progress
...
> vitest run
 ...
 Test Files  33 passed (33)
   ...
   Start at  20:42:22
   Duration  11.91s (transform 1.36s, setup 0ms, import 5.57s, tests 97.86s, environment 7ms)
...
Markdown links OK (630 file(s) checked).
```
...
> agentloopkit@0.26.5 smoke:release
> node scripts/smoke-packed-release.mjs

Release smoke for agentloopkit@0.26.5
Packed /var/folders/tc/vn86wd6d7v70rn_pxbv3h2k40000gn/T/agentloopkit-release-smoke-rdwqgm/pack/agentloopkit-0.26.5.tgz
...
> agentloopkit@0.26.5 prepublishOnly
> node scripts/prepublish-check.mjs && npm run typecheck && npm test && npm run build

Prepublish metadata check passed.

> agentloopkit@0.26.5 typecheck
> tsc --noEmit


> agentloopkit@0.26.5 test
> vitest run
 ...
 Test Files  33 passed (33)
      Tests  151 passed (151)
   Start at  20:42:51
   Duration  15.57s (transform 1.18s, setup 0ms, import 7.57s, tests 127.23s, environment 4ms)


> agentloopkit@0.26.5 build
> tsup && node scripts/copy-assets.mjs
...
DTS Build start
DTS ⚡️ Build success in 814ms
DTS dist/cli/index.d.ts 13.00 B
npm notice
npm notice 📦  agentloopkit@0.26.5
npm notice Tarball Contents
npm notice 1.1kB LICENSE
npm notice 25.6kB README.md
npm notice 13B dist/cli/index.d.ts
npm notice 158.5kB dist/cli/index.js
npm notice 300.4kB dist/cli/index.js.map
...
npm notice version: 0.26.5
npm notice filename: agentloopkit-0.26.5.tgz
npm notice package size: 122.5 kB
npm notice unpacked size: 537.7 kB
npm notice shasum: 3d65b4d2ea5ee533b1de30fd04f8cd6e9f4c9ff7
npm notice integrity: sha512-J5yzv49jPEIx6[...]V96MHhf4WNzUw==
