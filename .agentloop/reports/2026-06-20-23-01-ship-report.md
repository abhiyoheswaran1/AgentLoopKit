...
- Handoff: `.agentloop/handoffs/2026-06-20-23-01-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `75`/100 (weight `15`) - `13 non-evidence changed files is reviewable but not small; 19 AgentLoop evidence file(s) also present (32 total).`
...
- [`pass`] `Git context`: `33 changed file(s) detected (13 non-evidence, 20 AgentLoop evidence).`
