...
- Task: `Report post-ship gate state` (`in-progress`) - `.agentloop/tasks/2026-06-13-report-post-ship-gate-state.md`
- Verification: `pass` - `.agentloop/reports/2026-06-13-06-58-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-13-07-06-pr-summary.md`
- Gates: `pass`
...
- [`pass`] `Task contract`: `Report post-ship gate state`
