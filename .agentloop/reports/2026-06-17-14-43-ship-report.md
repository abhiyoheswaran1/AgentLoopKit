...
- Handoff: `.agentloop/handoffs/2026-06-17-14-43-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `108 non-evidence changed files is broad for one review; 2862 AgentLoop evidence file(s) also present (2970 total).`
...
- AgentLoop evidence: `2862` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
...
- [`pass`] `Git context`: `2971 changed file(s) detected (108 non-evidence, 2863 AgentLoop evidence).`
