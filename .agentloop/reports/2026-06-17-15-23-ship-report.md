...
- Generated: `2026-06-17-15-23`
- Review readiness score: `92`/100
- Task: `Reconcile verified non-release backlog decisions` (`done`) - `.agentloop/tasks/archive/2026-06-17-reconcile-verified-non-release-backlog-decisions-2.md`
- Verification: `pass` - `.agentloop/reports/2026-06-17-15-18-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-17-15-23-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `110 non-evidence changed files is broad for one review; 2939 AgentLoop evidence file(s) also present (3049 total).`
...
- AgentLoop evidence: `2939` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
...
.agentflight/config.json                           |    6 +-
 ...
 docs/cli-reference.md                              |   91 +-
 docs/configuration.md                              |    2 +
 docs/getting-started.md                            |    4 +-
 docs/html-reports.md                               |    6 +
 docs/maintenance-guards.md                         |    9 +-
 docs/policies.md                                   |    5 +-
 docs/release-checklist-example.md                  |   39 +-
 docs/release-notes.md                              |    4 +-
 docs/schemastore.md                                |    3 +-
 docs/status.md                                     |   34 +-
 docs/task-contracts.md                             |    4 +-
 docs/upgrading-existing-repos.md                   |   15 +
 scripts/dogfood-start.mjs                          |  145 +-
 scripts/dogfood.mjs                                |    8 +-
 scripts/maintenance-check.mjs                      |   30 +-
 scripts/smoke-cli.mjs                              | 2708 ++++++++++++++++++--
 scripts/smoke-packed-release.mjs                   |   47 +
 src/cli/commands/artifacts.ts                      |   32 +-
 src/cli/commands/badge.ts                          |   38 +-
 src/cli/commands/ci-summary.ts                     |   55 +-
 src/cli/commands/github.ts                         |    5 +
 src/cli/commands/init.ts                           |    5 +
 src/cli/commands/install-agent.ts                  |   48 +-
 src/cli/commands/next.ts                           |   42 +-
 src/cli/commands/policy.ts                         |   11 +
 src/cli/commands/release-notes.ts                  |    3 +
 src/cli/commands/report.ts                         |   40 +-
 src/cli/commands/review-context.ts                 |   28 +-
 src/cli/commands/runs.ts                           |   58 +-
 src/cli/commands/schemastore.ts                    |    6 +-
 src/cli/commands/status.ts                         |    4 +-
 src/cli/commands/task.ts                           |  332 ++-
 src/core/artifacts.ts                              |  152 +-
 src/core/change-areas.ts                           |   46 +
 src/core/check-gates.ts                            |   83 +-
 src/core/ci-summary.ts                             |   89 +-
 src/core/completions.ts                            |   24 +-
 ...
 src/core/release-notes.ts                          |   83 +-
 src/core/review-context.ts                         |   71 +-
 src/core/ship.ts                                   |    9 +-
 src/core/status.ts                                 |  204 +-
 src/core/task-state.ts                             |  365 ++-
 src/templates/harness/release-checklist.md         |   13 +
 src/templates/root/AGENTLOOP.md                    |    2 +
 tests/agent-installation.test.ts                   |  107 +-
 tests/artifacts.test.ts                            |  365 +++
 tests/autonomous-dogfood.test.ts                   |  160 +-
 tests/badge.test.ts                                |   54 +-
 tests/check-gates.test.ts                          |  155 +-
 tests/ci-summary.test.ts                           |  169 +-
 tests/completion.test.ts                           |   18 +
 tests/distribution-artifacts.test.ts               |  764 ++++++
 tests/dogfood-script.test.ts                       |   10 +-
 tests/dogfood-start-script.test.ts                 |  218 +-
 tests/github-metadata.test.ts                      |   42 +-
 tests/handoff.test.ts                              |  113 +-
 tests/html-report.test.ts                          |   83 +-
 tests/init.test.ts                                 |   92 +
 tests/maintainer-check.test.ts                     |  149 +-
 tests/maintenance-check-script.test.ts             |  137 +-
 tests/next.test.ts                                 |  231 ++
 tests/policy-packs.test.ts                         |   91 +-
 tests/policy.test.ts                               |   34 +
 tests/pr-summary.test.ts                           |    7 +-
 tests/prepare-pr.test.ts                           |   30 +-
 tests/public-docs-hygiene.test.ts                  |  100 +-
 tests/readiness-score.test.ts                      |   47 +
 tests/release-notes.test.ts                        |   87 +
 tests/release-smoke.test.ts                        |   46 +-
 tests/review-context.test.ts                       |   87 +-
 tests/roadmap-channels.test.ts                     |   96 +
 tests/runs.test.ts                                 |  273 +-
 tests/schemastore.test.ts                          |   20 +
 tests/ship.test.ts                                 |  159 +-
 tests/status.test.ts                               |  335 ++-
 tests/task-state.test.ts                           | 1225 ++++++++-
 95 files changed, 10429 insertions(+), 1234 deletions(-)
```

## Gate Summary

- [`pass`] `Task contract`: `Reconcile verified non-release backlog decisions`
- [`pass`] `Verification report`: `Overall status: pass`
- [`pass`] `Handoff summary`: `Reviewer handoff found.`
- [`pass`] `Task hygiene`: `Task folder hygiene checks passed.`
- [`pass`] `Repo harness`: `Required repo and harness files exist.`
- [`pass`] `Safety policies`: `Core safety policy files exist.`
- [`pass`] `Git context`: `3050 changed file(s) detected (110 non-evidence, 2940 AgentLoop evidence).`
