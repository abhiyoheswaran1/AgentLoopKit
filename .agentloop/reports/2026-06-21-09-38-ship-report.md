...
- Generated: `2026-06-21-09-38`
- Review readiness score: `92`/100
- Task: `Show dirty file examples in check-gates create-task guidance` (`in-progress`) - `.agentloop/tasks/2026-06-21-show-dirty-file-examples-in-check-gates-create-task-guidance.md`
- Verification: `pass` - `.agentloop/reports/2026-06-21-09-33-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-21-09-38-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `111 non-evidence changed files is broad for one review; 437 AgentLoop evidence file(s) also present (548 total). Non-evidence review areas: AgentLoop 42, Source 34, Tests 22, Documentation 10, CI / Automation 2, Config / Package 1.`
...
- AgentLoop evidence: `437` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
- Full paths remain in JSON output and run-ledger evidence.

## Diff Stat

```text
.agentloop/backlog.md                         | 201 ++++++++++++++++
 ...
 73 files changed, 2533 insertions(+), 298 deletions(-)
...
- [`pass`] `Task contract`: `Show dirty file examples in check-gates create-task guidance`
- [`pass`] `Verification report`: `Overall status: pass`
- [`pass`] `Handoff summary`: `Reviewer handoff found.`
- [`pass`] `Task hygiene`: `Task folder hygiene checks passed.`
- [`pass`] `Repo harness`: `Required repo and harness files exist.`
- [`pass`] `Safety policies`: `Core safety policy files exist.`
- [`pass`] `Git context`: `549 changed file(s) detected (111 non-evidence, 438 AgentLoop evidence).`
