...
- Task: `Add run ledger limit controls` (`in-progress`) - `.agentloop/tasks/2026-06-12-add-run-ledger-limit-controls.md`
- Verification: `pass` - `.agentloop/reports/2026-06-12-18-26-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-12-18-33-pr-summary.md`
- Gates: `pass`
...
- [`pass`] `Task contract`: `Add run ledger limit controls`
