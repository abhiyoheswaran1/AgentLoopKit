...
- Timestamp: `2026-06-21T05:07:30.506Z`
- Repo: `AgentLoopKit`
- Git branch: `main`
- Git commit: `32aec524`
- Working tree: `dirty`
...
## Task Context
- Path: `.agentloop/tasks/2026-06-21-collapse-empty-prepare-pr-optional-section-whitespace.md`
- Title: `Collapse empty prepare-pr optional-section whitespace`
- Task type: `docs`
- Status: `in-progress`
...
> vitest run tests/prepare-pr.test.ts
 ...
 Test Files  1 passed (1)
      Tests  12 passed (12)
   Start at  07:07:34
   Duration  115.86s (transform 122ms, setup 0ms, import 196ms, tests 111.44s, environment 0ms)
...
Markdown links OK (4709 file(s) checked).
```
