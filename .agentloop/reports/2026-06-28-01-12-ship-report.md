...
- Verification: `pass` - `.agentloop/reports/2026-06-28-00-39-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-28-01-12-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `33 non-evidence changed files is broad for one review; 14 AgentLoop evidence file(s) also present (47 total). Non-evidence review areas: Source 16, Documentation 7, Tests 5, AgentLoop 4, Config / Package 1.`
...
- Evidence map: `47` changed file(s); `33` covered, `0` unexplained; verification `fresh`; `0` risk-sensitive.
...
- ?? `tests/ready.test.ts`
- AgentLoop evidence: `14` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`.
...
.agentloop/README.md                             |  6 ++-
 ...
 25 files changed, 246 insertions(+), 28 deletions(-)
...
- [`pass`] `Git context`: `48 changed file(s) detected (33 non-evidence, 15 AgentLoop evidence).`
