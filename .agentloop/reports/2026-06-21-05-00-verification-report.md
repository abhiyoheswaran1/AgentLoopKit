...
- Timestamp: `2026-06-21T03:00:26.192Z`
- Repo: `AgentLoopKit`
- Git branch: `main`
- Git commit: `32aec524`
- Working tree: `dirty`
...
## Task Context
- Path: `.agentloop/tasks/2026-06-21-summarize-stale-artifact-preview-by-type.md`
- Title: `Summarize stale artifact preview by type`
- Task type: `feature`
- Status: `in-progress`
...
> vitest run tests/artifacts.test.ts
 ...
 Test Files  1 passed (1)
      Tests  37 passed (37)
   Start at  05:00:30
   Duration  153.70s (transform 50ms, setup 0ms, import 125ms, tests 153.19s, environment 0ms)
...
Markdown links OK (4649 file(s) checked).
```
