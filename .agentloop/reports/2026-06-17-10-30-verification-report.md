...
- Timestamp: `2026-06-17T08:30:14.259Z`
- Repo: `AgentLoopKit`
- Git branch: `main`
- Git commit: `370a9fe`
- Working tree: `dirty`
...
> vitest run tests/task-state.test.ts -t task show
 ...
 Test Files  1 passed (1)
   ...
   Start at  10:30:15
   Duration  10.85s (transform 262ms, setup 0ms, import 572ms, tests 9.84s, environment 0ms)
...
> vitest run tests/task-state.test.ts
 ...
 Test Files  1 passed (1)
      Tests  71 passed (71)
   Start at  10:30:30
   Duration  98.07s (transform 121ms, setup 0ms, import 219ms, tests 97.60s, environment 0ms)
...
AgentLoopKit: task="Accept redacted task show output flag" status="in-progress"; verification=pass; run="verify pass"; tree=dirty (2650; 105 non-evidence, 2545 AgentLoop evidence); next="agentloop handoff"
...
[output truncated: showing first 2500 and last 2500 characters of 9010 total]

context --redact-paths
...
- Latest verification: `pass` - `.agentloop/reports/2026-06-17-10-20-verification-report.md`
- Gates: `warn`
- Policy status: `8` current, `0` modified, `0` missing, `0` extra
- Artifacts: `3` task(s), `102` AgentFlight placeholder task(s), `525` verification report(s), `874` handoff(s)
...
- Working tree: `dirty (2650; 105 non-evidence, 2545 AgentLoop evidence)`
