...
- Handoff: `.agentloop/handoffs/2026-06-24-19-18-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `52 non-evidence changed files is broad for one review; 34 AgentLoop evidence file(s) also present (86 total). Non-evidence review areas: Source 22, AgentLoop 12, Documentation 12, Tests 6.`
...
- Evidence map: `86` changed file(s); `52` covered, `0` unexplained; verification `fresh`; `0` risk-sensitive.
...
- AgentLoop evidence: `34` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
...
- [`pass`] `Git context`: `87 changed file(s) detected (52 non-evidence, 35 AgentLoop evidence).`
