...
- Generated: `2026-06-21-04-47`
- Review readiness score: `92`/100
- Task: `Surface verification not-run details in PR handoffs` (`in-progress`) - `.agentloop/tasks/2026-06-21-surface-verification-not-run-details-in-pr-handoffs.md`
- Verification: `pass` - `.agentloop/reports/2026-06-21-04-42-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-21-04-47-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `83 non-evidence changed files is broad for one review; 254 AgentLoop evidence file(s) also present (337 total).`
...
- AgentLoop evidence: `254` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
- Full paths remain in JSON output and run-ledger evidence.

## Diff Stat

```text
.agentloop/backlog.md                         |  99 ++++++++
 ...
 62 files changed, 1629 insertions(+), 209 deletions(-)
...
- [`pass`] `Task contract`: `Surface verification not-run details in PR handoffs`
- [`pass`] `Verification report`: `Overall status: pass`
- [`pass`] `Handoff summary`: `Reviewer handoff found.`
- [`pass`] `Task hygiene`: `Task folder hygiene checks passed.`
- [`pass`] `Repo harness`: `Required repo and harness files exist.`
- [`pass`] `Safety policies`: `Core safety policy files exist.`
- [`pass`] `Git context`: `338 changed file(s) detected (83 non-evidence, 255 AgentLoop evidence).`
