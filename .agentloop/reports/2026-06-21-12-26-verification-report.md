...
- Timestamp: `2026-06-21T10:26:02.635Z`
- Repo: `AgentLoopKit`
- Git branch: `main`
- Git commit: `32aec524`
- Working tree: `dirty`
...
```text
    171|     ]);
    172|
    173|     expect(options.errors).toContain(
       |                            ^
    174|       'Unsupported task type "investigation". Supported task types: fe…
    175|     );
⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯⎯[1/1]⎯
 Test Files  1 failed | 63 passed (64)
      Tests  1 failed | 866 passed (867)
   Start at  12:26:08
   Duration  435.16s (transform 646ms, setup 0ms, import 3.12s, tests 4438.81s, environment 3ms)
...
> vitest run
 ...
 ❯ tests/dogfood-start-script.test.ts (9 tests | 1 failed) 701ms
     × rejects unsupported task types before starting AgentFlight 2ms

⎯⎯⎯⎯⎯⎯⎯ Failed Tests 1 ⎯⎯⎯⎯⎯⎯⎯

 FAIL  tests/dogfood-start-script.test.ts > dogfood start script helpers > rejects unsupported task types before starting AgentFlight
AssertionError: expected [ Array(1) ] to include 'Unsupported task type "investigation"…'
 ❯ tests/dogfood-start-script.test.ts:173:28
    171|     ]);
    172|
    173|     expect(options.errors).toContain(
       |                            ^
...
> vitest run tests/create-task.test.ts tests/completion.test.ts tests/init.test.ts
 ...
 Test Files  3 passed (3)
      Tests  69 passed (69)
   Start at  12:33:51
   Duration  104.88s (transform 120ms, setup 0ms, import 291ms, tests 167.97s, environment 0ms)
...
Markdown links OK (4852 file(s) checked).
```
