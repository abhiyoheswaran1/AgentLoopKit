...
- Timestamp: `2026-06-17T00:17:27.441Z`
- Repo: `AgentLoopKit`
- Git branch: `main`
- Git commit: `370a9fe`
- Working tree: `dirty`
...
## Task Context
- Path: `.agentloop/tasks/2026-06-17-add-built-cli-smoke-coverage-for-schemastore-output.md`
- Title: `Add built CLI smoke coverage for SchemaStore output`
- Task type: `tests`
- Status: `in-progress`
...
## Commands Run
### task: `npm test -- tests/distribution-artifacts.test.ts -t "CLI smoke script covers SchemaStore output"`
...
> vitest run tests/distribution-artifacts.test.ts -t CLI smoke script covers SchemaStore output
 ...
 Test Files  1 passed (1)
   ...
   Start at  02:17:28
   Duration  135ms (transform 15ms, setup 0ms, import 21ms, tests 2ms, environment 0ms)
...
> vitest run tests/distribution-artifacts.test.ts
 ...
 Test Files  1 passed (1)
      Tests  18 passed (18)
   Start at  02:17:28
   Duration  142ms (transform 15ms, setup 0ms, import 22ms, tests 7ms, environment 0ms)
...
AgentLoopKit: task="Add built CLI smoke coverage for SchemaStore output" status="in-progress"; verification=pass; run="handoff 1490 files"; tree=dirty (1498; 81 non-evidence, 1417 AgentLoop evidence); next="agentloop task done"
...
[output truncated: showing first 2500 and last 2500 characters of 9354 total]

tore output` (`in-progress`) - `.agentloop/tasks/2026-06-17-add-built-cli-smoke-coverage-for-schemastore-output.md`
- Latest verification: `pass` - `.agentloop/reports/2026-06-17-02-17-verification-report.md`
- Gates: `pass`
- Policy status: `8` current, `0` modified, `0` missing, `0` extra
- Artifacts: `3` task(s), `55` AgentFlight placeholder task(s), `472` verification report(s), `743` handoff(s)
- Latest ship score: `92`/100 - `.agentloop/reports/2026-06-17-02-13-ship-report.md`
- GitHub metadata: missing - `.agentloop/github/context.json`
- Working tree: `dirty (1498; 81 non-evidence, 1417 AgentLoop evidence)`

## Recent Runs

- `handoff` `1490` changed file(s) (`81` non-evidence, `1409` AgentLoop evidence) - `2026-06-17-02-13-handoff-2`
- `handoff` `1485` changed file(s) (`81` non-evidence, `1404` AgentLoop evidence) - `2026-06-17-02-13-handoff`
- `ship` `92`/100 - `1476` changed file(s) (`81` non-evidence, `1395` AgentLoop evidence) - `2026-06-17-02-13-ship`
...
Evidence saved:
- stdout: .agentflight/evidence/af-20260617-001424-add-built-cli-smoke-coverage-for-schemastore-output/verification-1.stdout.txt
- stderr: .agentflight/evidence/af-20260617-001424-add-built-cli-smoke-coverage-for-schemastore-output/verification-1.stderr.txt
...
> vitest run tests/distribution-artifacts.test.ts
 ...
 Test Files  1 passed (1)
      Tests  18 passed (18)
   Start at  02:17:58
   Duration  202ms (transform 22ms, setup 0ms, import 30ms, tests 24ms, environment 0ms)
```
