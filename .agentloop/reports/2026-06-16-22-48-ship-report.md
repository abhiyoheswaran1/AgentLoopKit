...
- Handoff: `.agentloop/handoffs/2026-06-16-22-48-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `616 changed files is broad for one review.`
...
- [`pass`] `Git context`: `617 changed file(s) detected.`
