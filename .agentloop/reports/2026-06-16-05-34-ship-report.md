...
- Task: `Make summarize output Markdown-safe` (`done`) - `.agentloop/tasks/archive/2026-06-16-make-summarize-output-markdown-safe.md`
- Verification: `pass` - `.agentloop/reports/2026-06-16-05-31-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-16-05-34-pr-summary-3.md`
- Gates: `warn`
...
- [`pass`] `Task contract`: `Make summarize output Markdown-safe`
