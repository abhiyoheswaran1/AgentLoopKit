...
- Task context: Add task list command
...
- ?? `.agentloop/reports/2026-06-09-17-46-verification-report.md`
- ?? `.agentloop/research/interview-cycle-023.md`
- ?? `.agentloop/tasks/2026-06-09-add-task-list-command.md`
...
.agentloop/backlog.md                            |  2 +
 ...
 src/cli/commands/task.ts                         | 34 +++++++++++++++-
 src/core/task-state.ts                           | 49 +++++++++++++++++++++++-
 ...
 src/templates/tasks/README.md                    |  3 ++
 tests/task-state.test.ts                         | 48 ++++++++++++++++++++++-
 24 files changed, 167 insertions(+), 6 deletions(-)
