...
- Task context: `Add built CLI smoke coverage for latest ship report artifacts`
...
- AgentLoop evidence: `2770` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
