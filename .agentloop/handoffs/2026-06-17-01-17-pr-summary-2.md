...
- Task context: `Separate AgentLoop evidence churn in review-context runs`
...
- AgentLoop evidence: `1155` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
