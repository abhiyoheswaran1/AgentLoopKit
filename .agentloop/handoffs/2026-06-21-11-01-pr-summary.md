...
- Generated: 2026-06-21-11-01
- Task context: `Enforce agent-assisted product language`
...
- AgentLoop evidence: `500` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
