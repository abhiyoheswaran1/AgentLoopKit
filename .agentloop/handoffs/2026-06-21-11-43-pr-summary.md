...
- Generated: 2026-06-21-11-43
- Task context: `Use engineering-session wording in create-task guidance`
...
- AgentLoop evidence: `532` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
