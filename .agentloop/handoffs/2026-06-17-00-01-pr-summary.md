...
- Generated: 2026-06-17-00-01
- Task context: `Ignore generated evidence in ProjScan scans`
...
- AgentLoop evidence: `791` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
...
.agentflight/config.json                           |   6 +-
 ...
 52 files changed, 3088 insertions(+), 217 deletions(-)
```
