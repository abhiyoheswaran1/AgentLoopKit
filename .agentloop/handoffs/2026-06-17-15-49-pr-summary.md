...
- Generated: 2026-06-17-15-49
- Task context: `Clarify raw AgentFlight active-task recovery`
...
- AgentLoop evidence: `2975` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
...
.agentflight/config.json                           |    6 +-
 ...
 tests/autonomous-dogfood.test.ts                   |  173 +-
 ...
 95 files changed, 10662 insertions(+), 1234 deletions(-)
```
