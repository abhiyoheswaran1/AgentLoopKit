...
- Task context: `Clarify task archive next step after existing evidence`
...
- AgentLoop evidence: `2810` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
