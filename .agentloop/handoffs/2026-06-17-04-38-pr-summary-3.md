...
- Task context: `Add built CLI smoke coverage for task-list JSON groups`
...
- AgentLoop evidence: `1898` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
