...
- Generated: 2026-06-17-05-39
- Task context: `Add built CLI smoke coverage for stale task state recovery`
...
- AgentLoop evidence: `2004` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
