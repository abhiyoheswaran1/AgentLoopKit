# Prepare 0.12.0 create-task JSON release
...
## Problem Statement
create-task --json is implemented on main, but package metadata, changelog, README visuals, and release notes still point at 0.11.0.

## Desired Outcome
Prepare a verified 0.12.0 GitHub release candidate for create-task JSON output while keeping npm availability status honest.
...
## Rollback Notes
Revert the 0.12.0 metadata bump, changelog entry, README/doc changes, regenerated README assets, and release-status records.
