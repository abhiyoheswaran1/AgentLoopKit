...
| Add `agentloop status`              | Lina, Tom              | Users need a quick local summary of active task, latest report, and dirty files. | Add deterministic `status` command.                                                           | P1       | M      | high            | low    | later    | Good next CLI feature after this cycle.                   |
| Better failed-command excerpts      | Tom, Maya              | Verification reports can be verbose.                                             | Add clearer first/last output excerpts.                                                       | P2       | M      | medium          | low    | later    | Keep command output honest.                               |
