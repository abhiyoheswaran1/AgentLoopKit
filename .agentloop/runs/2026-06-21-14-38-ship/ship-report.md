...
- Generated: `2026-06-21-14-38`
- Review readiness score: `88`/100
- Task: `Surface active task loop guidance in status` (`in-progress`) - `.agentloop/tasks/2026-06-21-surface-active-task-loop-guidance-in-status.md`
- Verification: `pass` - `.agentloop/reports/2026-06-21-14-03-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-21-14-38-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `30`/100 (weight `15`) - `149 non-evidence changed files is broad for one review; 610 AgentLoop evidence file(s) also present (759 total). Non-evidence review areas: AgentLoop 53, Source 46, Tests 27, Documentation 17, CI / Automation 4, Config / Package 1, Risk-Sensitive 1.`
...
- Task started with `149` dirty non-evidence file(s); current non-evidence changed files: `149` (net `0`).
...
.agentloop/README.md                               |   2 +-
 ...
 103 files changed, 3545 insertions(+), 426 deletions(-)
...
- [`pass`] `Task contract`: `Surface active task loop guidance in status`
- [`pass`] `Verification report`: `Overall status: pass`
- [`pass`] `Handoff summary`: `Reviewer handoff found.`
- [`pass`] `Task hygiene`: `Task folder hygiene checks passed.`
- [`pass`] `Repo harness`: `Required repo and harness files exist.`
- [`pass`] `Safety policies`: `Core safety policy files exist.`
- [`pass`] `Git context`: `760 changed file(s) detected (149 non-evidence, 611 AgentLoop evidence).`
