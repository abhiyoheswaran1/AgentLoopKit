...
- Task context: `Add built CLI smoke coverage for stale artifact limits`
...
- AgentLoop evidence: `2690` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
