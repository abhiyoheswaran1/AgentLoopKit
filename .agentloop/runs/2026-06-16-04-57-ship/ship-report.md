...
- Handoff: `.agentloop/handoffs/2026-06-16-04-57-pr-summary-3.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `35 changed files is broad for one review.`
...
- [`pass`] `Git context`: `36 changed file(s) detected.`
