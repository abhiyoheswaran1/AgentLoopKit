...
- Timestamp: `2026-06-21T07:59:38.298Z`
- Repo: `AgentLoopKit`
- Git branch: `main`
- Git commit: `32aec524`
- Working tree: `dirty`
...
## Task Context
- Path: `.agentloop/tasks/2026-06-21-show-gate-evidence-source-in-review-context.md`
- Title: `Show gate evidence source in review context`
- Task type: `feature`
- Status: `in-progress`
...
> vitest run tests/review-context.test.ts
 ...
 Test Files  1 passed (1)
      Tests  7 passed (7)
   Start at  09:59:42
   Duration  31.46s (transform 103ms, setup 0ms, import 175ms, tests 30.91s, environment 0ms)
...
Markdown links OK (4789 file(s) checked).
```
