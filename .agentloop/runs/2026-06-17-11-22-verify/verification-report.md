...
- Timestamp: `2026-06-17T09:16:14.120Z`
- Repo: `AgentLoopKit`
- Git branch: `main`
- Git commit: `370a9fe`
- Working tree: `dirty`
...
## Task Context
- Path: `.agentloop/tasks/2026-06-17-add-built-cli-smoke-coverage-for-archived-task-doctor-pass-2.md`
- Title: `Add built CLI smoke coverage for archived task doctor pass`
- Task type: `tests`
- Status: `in-progress`
...
> vitest run
 ...
 Test Files  63 passed (63)
   ...
   Start at  11:16:17
   Duration  280.15s (transform 1.28s, setup 0ms, import 6.35s, tests 2715.86s, environment 6ms)
...
### task: `npm test -- tests/distribution-artifacts.test.ts -t "archived task doctor"`
...
> vitest run tests/distribution-artifacts.test.ts -t archived task doctor
 ...
 Test Files  1 passed (1)
   ...
   Start at  11:21:17
   Duration  202ms (transform 39ms, setup 0ms, import 50ms, tests 3ms, environment 0ms)
...
> vitest run tests/distribution-artifacts.test.ts
 ...
 Test Files  1 passed (1)
      Tests  48 passed (48)
   Start at  11:22:21
   Duration  451ms (transform 23ms, setup 0ms, import 31ms, tests 19ms, environment 0ms)
