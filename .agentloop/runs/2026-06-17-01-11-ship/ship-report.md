...
- Generated: `2026-06-17-01-11`
- Review readiness score: `92`/100
- Task: `Separate AgentLoop evidence churn in run ledger output` (`in-progress`) - `.agentloop/tasks/2026-06-17-separate-agentloop-evidence-churn-in-run-ledger-output-2.md`
- Verification: `pass` - `.agentloop/reports/2026-06-17-01-10-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-17-01-11-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `76 non-evidence changed files is broad for one review; 1116 AgentLoop evidence file(s) also present (1192 total).`
...
- AgentLoop evidence: `1116` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
...
.agentflight/config.json                           |   6 +-
 ...
 61 files changed, 3758 insertions(+), 270 deletions(-)
```

## Gate Summary

- [`pass`] `Task contract`: `Separate AgentLoop evidence churn in run ledger output`
- [`pass`] `Verification report`: `Overall status: pass`
- [`pass`] `Handoff summary`: `Reviewer handoff found.`
- [`pass`] `Task hygiene`: `Task folder hygiene checks passed.`
- [`pass`] `Repo harness`: `Required repo and harness files exist.`
- [`pass`] `Safety policies`: `Core safety policy files exist.`
- [`pass`] `Git context`: `1193 changed file(s) detected (76 non-evidence, 1117 AgentLoop evidence).`
