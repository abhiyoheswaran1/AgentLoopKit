...
- Generated: `2026-06-21-10-18`
- Review readiness score: `92`/100
- Task: `Show inherited dirty-work baseline in ship reports` (`in-progress`) - `.agentloop/tasks/2026-06-21-show-inherited-dirty-work-baseline-in-ship-reports.md`
- Verification: `pass` - `.agentloop/reports/2026-06-21-10-13-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-21-10-18-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `114 non-evidence changed files is broad for one review; 485 AgentLoop evidence file(s) also present (599 total). Non-evidence review areas: AgentLoop 45, Source 34, Tests 22, Documentation 10, CI / Automation 2, Config / Package 1.`
...
- Task started with `113` dirty non-evidence file(s); current non-evidence changed files: `114` (net `+1`).
...
- AgentLoop evidence: `485` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
- Full paths remain in JSON output and run-ledger evidence.

## Diff Stat

```text
.agentloop/backlog.md                         | 209 ++++++++++++++++
 ...
 tests/maintainer-check.test.ts                |  91 ++++++-
...
- [`pass`] `Task contract`: `Show inherited dirty-work baseline in ship reports`
- [`pass`] `Verification report`: `Overall status: pass`
- [`pass`] `Handoff summary`: `Reviewer handoff found.`
- [`pass`] `Task hygiene`: `Task folder hygiene checks passed.`
- [`pass`] `Repo harness`: `Required repo and harness files exist.`
- [`pass`] `Safety policies`: `Core safety policy files exist.`
- [`pass`] `Git context`: `600 changed file(s) detected (114 non-evidence, 486 AgentLoop evidence).`
