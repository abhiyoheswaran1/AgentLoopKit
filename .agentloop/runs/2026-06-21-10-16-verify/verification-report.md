...
- Timestamp: `2026-06-21T08:13:41.370Z`
- Repo: `AgentLoopKit`
- Git branch: `main`
- Git commit: `32aec524`
- Working tree: `dirty`
...
## Task Context
- Path: `.agentloop/tasks/2026-06-21-show-inherited-dirty-work-baseline-in-ship-reports.md`
- Title: `Show inherited dirty-work baseline in ship reports`
- Task type: `feature`
- Status: `in-progress`
...
> vitest run tests/ship.test.ts
 ...
 Test Files  1 passed (1)
      Tests  17 passed (17)
   Start at  10:13:46
   Duration  146.91s (transform 111ms, setup 0ms, import 188ms, tests 146.34s, environment 0ms)
...
Markdown links OK (4800 file(s) checked).
```
