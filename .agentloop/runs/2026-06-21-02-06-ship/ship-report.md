...
- Generated: `2026-06-21-02-06`
- Review readiness score: `92`/100
- Task: `Clarify archived task evidence in artifacts output` (`in-progress`) - `.agentloop/tasks/2026-06-21-clarify-archived-task-evidence-in-artifacts-output.md`
- Verification: `pass` - `.agentloop/reports/2026-06-21-02-01-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-21-02-06-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `53 non-evidence changed files is broad for one review; 136 AgentLoop evidence file(s) also present (189 total).`
...
- AgentLoop evidence: `136` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
- Full paths remain in JSON output and run-ledger evidence.

## Diff Stat

```text
.agentloop/backlog.md                      |  39 ++++
 ...
 44 files changed, 892 insertions(+), 114 deletions(-)
...
- [`pass`] `Task contract`: `Clarify archived task evidence in artifacts output`
- [`pass`] `Verification report`: `Overall status: pass`
- [`pass`] `Handoff summary`: `Reviewer handoff found.`
- [`pass`] `Task hygiene`: `Task folder hygiene checks passed.`
- [`pass`] `Repo harness`: `Required repo and harness files exist.`
- [`pass`] `Safety policies`: `Core safety policy files exist.`
- [`pass`] `Git context`: `190 changed file(s) detected (53 non-evidence, 137 AgentLoop evidence).`
