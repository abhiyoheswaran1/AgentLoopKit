...
- Generated: `2026-06-20-08-46`
- Review readiness score: `96`/100
- Task: `Make doctor pre-init safe for copy-paste trials` (`in-progress`) - `.agentloop/tasks/2026-06-20-make-doctor-pre-init-safe-for-copy-paste-trials.md`
- Verification: `pass` - `.agentloop/reports/2026-06-20-08-43-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-20-08-46-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `75`/100 (weight `15`) - `12 non-evidence changed files is reviewable but not small; 6 AgentLoop evidence file(s) also present (18 total).`
...
- [`pass`] `Git context`: `19 changed file(s) detected (12 non-evidence, 7 AgentLoop evidence).`
