...
- Task: `Show task risk-note count in review context` (`in-progress`) - `.agentloop/tasks/2026-06-21-show-task-risk-note-count-in-review-context.md`
- Verification: `pass` - `.agentloop/reports/2026-06-21-03-41-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-21-03-43-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `65 non-evidence changed files is broad for one review; 198 AgentLoop evidence file(s) also present (263 total).`
...
- AgentLoop evidence: `198` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
...
.agentloop/backlog.md                      |  69 ++++++
 ...
 50 files changed, 1201 insertions(+), 164 deletions(-)
...
- [`pass`] `Task contract`: `Show task risk-note count in review context`
- [`pass`] `Verification report`: `Overall status: pass`
- [`pass`] `Handoff summary`: `Reviewer handoff found.`
- [`pass`] `Task hygiene`: `Task folder hygiene checks passed.`
- [`pass`] `Repo harness`: `Required repo and harness files exist.`
- [`pass`] `Safety policies`: `Core safety policy files exist.`
- [`pass`] `Git context`: `264 changed file(s) detected (65 non-evidence, 199 AgentLoop evidence).`
