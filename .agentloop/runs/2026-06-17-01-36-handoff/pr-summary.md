...
- Generated: 2026-06-17-01-36
- Task context: `Warn on forced home-directory init`
...
- AgentLoop evidence: `1230` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
