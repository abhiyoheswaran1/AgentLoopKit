...
- Task context: `Base ship scope-control scoring on non-evidence changes`
...
- AgentLoop evidence: `1074` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
