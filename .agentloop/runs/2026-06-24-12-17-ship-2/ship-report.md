...
- Handoff: `.agentloop/handoffs/2026-06-24-12-17-pr-summary-3.md`
- Gates: `pass`
...
- `Scope control`: `75`/100 (weight `15`) - `13 non-evidence changed files is reviewable but not small; 36 AgentLoop evidence file(s) also present (49 total).`
...
- Evidence map: `49` changed file(s); `13` covered, `0` unexplained; verification `fresh`; `0` risk-sensitive.
...
- [`pass`] `Git context`: `50 changed file(s) detected (13 non-evidence, 37 AgentLoop evidence).`
