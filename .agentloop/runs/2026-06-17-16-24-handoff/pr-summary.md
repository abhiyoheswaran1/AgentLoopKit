...
- Generated: 2026-06-17-16-24
- Task context: `Add built CLI smoke coverage for release-check evidence split`
...
- AgentLoop evidence: `3012` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
...
.agentflight/config.json                           |    6 +-
 ...
 100 files changed, 10759 insertions(+), 1204 deletions(-)
```
