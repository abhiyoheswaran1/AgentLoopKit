...
- AgentLoop evidence: `21` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/archive/`.
...
.agentloop/README.md                             |   2 +-
 ...
 21 files changed, 777 insertions(+), 32 deletions(-)
