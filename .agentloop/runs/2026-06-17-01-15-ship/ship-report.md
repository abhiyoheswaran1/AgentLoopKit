...
- Generated: `2026-06-17-01-15`
- Review readiness score: `92`/100
- Task: `Separate AgentLoop evidence churn in review-context runs` (`in-progress`) - `.agentloop/tasks/2026-06-17-separate-agentloop-evidence-churn-in-review-context-runs-2.md`
- Verification: `pass` - `.agentloop/reports/2026-06-17-01-15-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-17-01-15-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `77 non-evidence changed files is broad for one review; 1141 AgentLoop evidence file(s) also present (1218 total).`
...
.agentflight/config.json                           |   6 +-
 ...
 62 files changed, 3868 insertions(+), 277 deletions(-)
```

## Gate Summary

- [`pass`] `Task contract`: `Separate AgentLoop evidence churn in review-context runs`
- [`pass`] `Verification report`: `Overall status: pass`
- [`pass`] `Handoff summary`: `Reviewer handoff found.`
- [`pass`] `Task hygiene`: `Task folder hygiene checks passed.`
- [`pass`] `Repo harness`: `Required repo and harness files exist.`
- [`pass`] `Safety policies`: `Core safety policy files exist.`
- [`pass`] `Git context`: `1219 changed file(s) detected (77 non-evidence, 1142 AgentLoop evidence).`
