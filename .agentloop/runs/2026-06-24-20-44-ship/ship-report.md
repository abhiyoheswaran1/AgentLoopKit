...
- Task: `Compact context pack JSON payloads` (`in-progress`) - `.agentloop/tasks/2026-06-24-compact-context-pack-json-payloads.md`
- Verification: `pass` - `.agentloop/reports/2026-06-24-20-42-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-24-20-44-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `60 non-evidence changed files is broad for one review; 130 AgentLoop evidence file(s) also present (190 total). Non-evidence review areas: Source 26, Documentation 14, AgentLoop 12, Tests 8.`
...
- Evidence map: `190` changed file(s); `60` covered, `0` unexplained; verification `fresh`; `0` risk-sensitive.

## Inherited Dirty Work

- Task started with `60` dirty non-evidence file(s); current non-evidence changed files: `60` (net `0`).
...
- AgentLoop evidence: `130` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
...
.agentloop/README.md                               |   6 +
 ...
 src/cli/commands/runs.ts                           |   9 +-
 src/core/agent-start.ts                            | 107 +++++-
 src/core/context-contract.ts                       | 249 +++++++++++--
 src/core/doctor.ts                                 |  51 ++-
 src/core/evidence-map.ts                           |  69 +++-
 src/core/mcp-tools.ts                              | 132 +++++--
 src/core/runs.ts                                   | 259 +++++++++----
 ...
 tests/mcp-tools.test.ts                            | 183 +++++++++-
 tests/runs.test.ts                                 | 402 ++++++++++++++++++++-
 tests/upgrade-harness.test.ts                      |  77 +++-
 54 files changed, 2455 insertions(+), 223 deletions(-)
...
- [`pass`] `Task contract`: `Compact context pack JSON payloads`
- [`pass`] `Verification report`: `Overall status: pass`
- [`pass`] `Handoff summary`: `Reviewer handoff found.`
- [`pass`] `Task hygiene`: `Task folder hygiene checks passed.`
- [`pass`] `Repo harness`: `Required repo and harness files exist.`
- [`pass`] `Safety policies`: `Core safety policy files exist.`
- [`pass`] `Git context`: `191 changed file(s) detected (60 non-evidence, 131 AgentLoop evidence).`
