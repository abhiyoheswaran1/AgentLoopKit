...
- Generated: 2026-06-17-02-10
- Task context: `Add built CLI smoke coverage for install-agent preservation`
...
- AgentLoop evidence: `1384` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
