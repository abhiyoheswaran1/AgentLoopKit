...
- Task: `Preserve same-minute prepare-pr artifacts` (`in-progress`) - `.agentloop/tasks/2026-06-16-preserve-same-minute-prepare-pr-artifacts-2.md`
- Verification: `pass` - `.agentloop/reports/2026-06-16-08-12-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-16-08-14-pr-summary.md`
- Gates: `pass`
...
- [`pass`] `Task contract`: `Preserve same-minute prepare-pr artifacts`
