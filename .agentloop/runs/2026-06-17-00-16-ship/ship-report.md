...
- Handoff: `.agentloop/handoffs/2026-06-17-00-16-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `917 changed files is broad for one review.`
...
- [`pass`] `Git context`: `918 changed file(s) detected.`
