...
## Changed Files
- M `.agentloop/tasks/2026-06-16-prevent-stale-agentloop-task-state.md`
...
- ?? `.agentloop/tasks/2026-06-16-prevent-stale-agentloop-task-state-2.md`
...
## Diff Stats
```text
...026-06-16-prevent-stale-agentloop-task-state.md |   2 +-
 ...
 src/core/task-state.ts                             | 230 ++++++++++++++++-
 src/templates/root/AGENTLOOP.md                    |   2 +
 tests/next.test.ts                                 |  38 +++
 tests/status.test.ts                               |  38 +++
 tests/task-state.test.ts                           | 282 +++++++++++++++++++++
 14 files changed, 700 insertions(+), 13 deletions(-)
```
