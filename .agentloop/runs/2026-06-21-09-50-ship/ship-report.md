...
- Generated: `2026-06-21-09-50`
- Review readiness score: `92`/100
- Task: `Clarify maintainer-check package warning labels` (`in-progress`) - `.agentloop/tasks/2026-06-21-clarify-maintainer-check-package-warning-labels.md`
- Verification: `pass` - `.agentloop/reports/2026-06-21-09-47-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-21-09-50-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `112 non-evidence changed files is broad for one review; 448 AgentLoop evidence file(s) also present (560 total). Non-evidence review areas: AgentLoop 43, Source 34, Tests 22, Documentation 10, CI / Automation 2, Config / Package 1.`
...
- AgentLoop evidence: `448` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
- Full paths remain in JSON output and run-ledger evidence.

## Diff Stat

```text
.agentloop/backlog.md                         | 207 ++++++++++++++++
 ...
 73 files changed, 2569 insertions(+), 299 deletions(-)
...
- [`pass`] `Task contract`: `Clarify maintainer-check package warning labels`
- [`pass`] `Verification report`: `Overall status: pass`
- [`pass`] `Handoff summary`: `Reviewer handoff found.`
- [`pass`] `Task hygiene`: `Task folder hygiene checks passed.`
- [`pass`] `Repo harness`: `Required repo and harness files exist.`
- [`pass`] `Safety policies`: `Core safety policy files exist.`
- [`pass`] `Git context`: `561 changed file(s) detected (112 non-evidence, 449 AgentLoop evidence).`
