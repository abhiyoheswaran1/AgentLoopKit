...
- Task: `Make task lifecycle output Markdown-safe` (`in-progress`) - `.agentloop/tasks/2026-06-16-make-task-lifecycle-output-markdown-safe.md`
- Verification: `pass` - `.agentloop/reports/2026-06-16-03-25-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-16-03-28-pr-summary.md`
- Gates: `pass`
...
- [`pass`] `Task contract`: `Make task lifecycle output Markdown-safe`
