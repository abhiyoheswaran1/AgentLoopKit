...
- Timestamp: `2026-06-17T11:03:24.186Z`
- Repo: `AgentLoopKit`
- Git branch: `main`
- Git commit: `370a9fe`
- Working tree: `dirty`
...
## Task Context
- Path: `.agentloop/tasks/2026-06-17-add-built-cli-smoke-coverage-for-default-stale-preview-cap-2.md`
- Title: `Add built CLI smoke coverage for default stale preview cap`
- Task type: `tests`
- Status: `in-progress`
...
> vitest run
 ...
 Test Files  63 passed (63)
   ...
   Start at  13:03:26
   Duration  235.06s (transform 1.23s, setup 0ms, import 5.19s, tests 2298.30s, environment 5ms)
...
### task: `npm test -- tests/distribution-artifacts.test.ts -t "default stale preview"`
...
> vitest run tests/distribution-artifacts.test.ts -t default stale preview
 ...
 Test Files  1 passed (1)
   ...
   Start at  13:07:38
   Duration  505ms (transform 30ms, setup 0ms, import 40ms, tests 4ms, environment 0ms)
...
> vitest run tests/distribution-artifacts.test.ts
 ...
 Test Files  1 passed (1)
      Tests  52 passed (52)
   Start at  13:07:41
   Duration  188ms (transform 24ms, setup 0ms, import 34ms, tests 23ms, environment 0ms)
...
AgentLoopKit: task="Add built CLI smoke coverage for default stale preview cap" status="in-progress"; verification=pass; run="ship 92/100"; tree=dirty (2852; 105 non-evidence, 2747 AgentLoop evidence); next="agentloop task done"
...
[output truncated: showing first 2500 and last 2500 characters of 9481 total]

rogress`) - `.agentloop/tasks/2026-06-17-add-built-cli-smoke-coverage-for-default-stale-preview-cap-2.md`
- Latest verification: `pass` - `.agentloop/reports/2026-06-17-13-03-verification-report.md`
- Gates: `pass`
- Policy status: `8` current, `0` modified, `0` missing, `0` extra
- Artifacts: `3` task(s), `113` AgentFlight placeholder task(s), `540` verification report(s), `897` handoff(s)
- Latest ship score: `92`/100 - `.agentloop/reports/2026-06-17-12-58-ship-report.md`
- GitHub metadata: missing - `.agentloop/github/context.json`
- Working tree: `dirty (2852; 105 non-evidence, 2747 AgentLoop evidence)`

## Recent Runs

- `ship` `92`/100 - `2840` changed file(s) (`105` non-evidence, `2735` AgentLoop evidence) - `2026-06-17-12-58-ship`
- `handoff` `2835` changed file(s) (`105` non-evidence, `2730` AgentLoop evidence) - `2026-06-17-12-58-handoff`
- `verify` `pass` - `2832` changed file(s) (`105` non-evidence, `2727` AgentLoop evidence) - `2026-06-17-12-55-verify`
