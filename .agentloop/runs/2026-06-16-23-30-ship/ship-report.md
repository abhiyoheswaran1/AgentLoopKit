...
- Verification: `pass` - `.agentloop/reports/2026-06-16-23-22-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-16-23-30-pr-summary.md`
- Gates: `fail`
...
- `Scope control`: `45`/100 (weight `15`) - `742 changed files is broad for one review.`
...
- [`pass`] `Git context`: `743 changed file(s) detected.`
