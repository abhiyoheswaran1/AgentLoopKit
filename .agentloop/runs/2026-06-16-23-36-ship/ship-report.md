...
- Handoff: `.agentloop/handoffs/2026-06-16-23-36-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `751 changed files is broad for one review.`
...
- [`pass`] `Git context`: `752 changed file(s) detected.`
