...
- Generated: `2026-06-21-06-18`
- Review readiness score: `92`/100
- Task: `Show review-area counts in ship scope warnings` (`in-progress`) - `.agentloop/tasks/2026-06-21-show-review-area-counts-in-ship-scope-warnings.md`
- Verification: `pass` - `.agentloop/reports/2026-06-21-06-15-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-21-06-18-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `96 non-evidence changed files is broad for one review; 315 AgentLoop evidence file(s) also present (411 total). Non-evidence review areas: AgentLoop 31, Source 31, Tests 21, Documentation 10, CI / Automation 2, Config / Package 1.`
...
.agentloop/backlog.md                         | 135 +++++++++++
 ...
 69 files changed, 2039 insertions(+), 266 deletions(-)
...
- [`pass`] `Task contract`: `Show review-area counts in ship scope warnings`
- [`pass`] `Verification report`: `Overall status: pass`
- [`pass`] `Handoff summary`: `Reviewer handoff found.`
- [`pass`] `Task hygiene`: `Task folder hygiene checks passed.`
- [`pass`] `Repo harness`: `Required repo and harness files exist.`
- [`pass`] `Safety policies`: `Core safety policy files exist.`
- [`pass`] `Git context`: `412 changed file(s) detected (96 non-evidence, 316 AgentLoop evidence).`
