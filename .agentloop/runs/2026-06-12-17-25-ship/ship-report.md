...
- Task: `Add verification progress output` (`in-progress`) - `.agentloop/tasks/2026-06-12-add-verification-progress-output.md`
- Verification: `pass` - `.agentloop/reports/2026-06-12-17-19-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-12-17-25-pr-summary.md`
- Gates: `pass`
...
- [`pass`] `Task contract`: `Add verification progress output`
