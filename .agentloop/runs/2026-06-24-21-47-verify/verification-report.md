...
- Timestamp: `2026-06-24T19:45:55.484Z`
- Repo: `AgentLoopKit`
- Git branch: `main`
- Git commit: `637b843c`
- Working tree: `dirty`
...
## Task Context
- Path: `.agentloop/tasks/2026-06-24-bound-mcp-evidence-listing-work-2.md`
- Title: `Bound MCP evidence listing work`
- Task type: `feature`
- Status: `in-progress`
...
## Commands Run
### task: `npm run test:unit -- tests/mcp-tools.test.ts tests/artifacts.test.ts`
...
> vitest run tests/config.test.ts tests/slug.test.ts tests/template-renderer.test.ts tests/markdown-format.test.ts tests/package-manager.test.ts tests/project-detection.test.ts tests/schema.test.ts tests/schemastore.test.ts tests/policy-packs.test.ts tests/github-metadata.test.ts tests/github-action-runner.test.ts tests/release-proof.test.ts tests/readiness-score.test.ts tests/public-docs-hygiene.test.ts tests/product-positioning.test.ts tests/roadmap-channels.test.ts tests/autonomous-dogfood.test.ts tests/dogfood-start-script.test.ts tests/maintenance-check-script.test.ts tests/cli-docs-drift.test.ts tests/safety.test.ts tests/version.test.ts tests/package-metadata.test.ts tests/package-scripts.test.ts tests/post-verification-gates.test.ts tests/task-contract.test.ts tests/mcp-tools.test.ts tests/artifacts.test.ts
 ...
 Test Files  28 passed (28)
   ...
   Start at  21:45:56
   Duration  63.92s (transform 420ms, setup 0ms, import 1.20s, tests 144.49s, environment 2ms)
...
ESM Build start
ESM dist/cli/index.js     633.31 KB
ESM dist/cli/index.js.map 1.16 MB
ESM ⚡️ Build success in 67ms
DTS Build start
DTS ⚡️ Build success in 1613ms
...
AgentLoopKit: task="Bound MCP evidence listing work" status="in-progress"; verification=pass; run="verify pass"; tree=dirty (282; 67 non-evidence, 215 AgentLoop evidence); next="agentloop handoff"
...
$ npx --no-install tsx src/cli/index.ts check-gates --

[output truncated: showing first 2500 and last 2500 characters of 13813 total]

src/cli/commands/runs.ts, src/core/agent-start.ts, src/core/artifacts.ts, src/core/context-contract.ts, src/core/doctor.ts, src/core/evidence-map.ts, src/core/markdown-format.ts, src/core/mcp-tools.ts, src/core/prepare-pr.ts, src/core/review-context.ts, src/core/runs.ts, src/core/upgrade-harness.ts, src/mcp/server.ts, src/core/agent-readiness.ts, src/core/run-artifacts.ts, src/core/run-types.ts
...
2 passed, 0 failed
- passed: npm run test:unit -- tests/mcp-tools.test.ts tests/artifacts.test.ts tests/runs.test.ts (exit 0, 71743ms)
- passed: npm run lint (exit 0, 3806ms)
