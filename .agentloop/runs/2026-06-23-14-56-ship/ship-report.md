...
- Verification: `pass` - `.agentloop/reports/2026-06-23-14-39-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-23-14-56-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `32 non-evidence changed files is broad for one review; 6 AgentLoop evidence file(s) also present (38 total). Non-evidence review areas: Source 15, Documentation 11, Tests 4, AgentLoop 2.`
...
- Evidence map: `38` changed file(s); `32` covered, `0` unexplained; verification `fresh`; `0` risk-sensitive.
...
- [`pass`] `Git context`: `39 changed file(s) detected (32 non-evidence, 7 AgentLoop evidence).`
