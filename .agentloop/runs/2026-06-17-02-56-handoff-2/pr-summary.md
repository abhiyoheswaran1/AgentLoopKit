...
- Task context: `Guard ship scoring from GitHub metadata`
...
- AgentLoop evidence: `1589` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
