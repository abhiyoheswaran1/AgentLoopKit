...
- Generated: 2026-06-17-16-16
- Task context: `Separate AgentLoop evidence churn in release-check`
...
- AgentLoop evidence: `3001` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
...
.agentflight/config.json                           |    6 +-
 ...
 100 files changed, 10767 insertions(+), 1242 deletions(-)
```
