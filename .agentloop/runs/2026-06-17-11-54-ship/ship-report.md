...
- Generated: `2026-06-17-11-54`
- Review readiness score: `92`/100
- Task: `Filter task list by status` (`in-progress`) - `.agentloop/tasks/2026-06-17-filter-task-list-by-status.md`
- Verification: `pass` - `.agentloop/reports/2026-06-17-11-47-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-17-11-54-pr-summary-2.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `105 non-evidence changed files is broad for one review; 2646 AgentLoop evidence file(s) also present (2751 total).`
...
- AgentLoop evidence: `2646` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
...
.agentflight/config.json                           |    6 +-
 ...
 90 files changed, 8780 insertions(+), 759 deletions(-)
```

## Gate Summary

- [`pass`] `Task contract`: `Filter task list by status`
- [`pass`] `Verification report`: `Overall status: pass`
- [`pass`] `Handoff summary`: `Reviewer handoff found.`
- [`pass`] `Task hygiene`: `Task folder hygiene checks passed.`
- [`pass`] `Repo harness`: `Required repo and harness files exist.`
- [`pass`] `Safety policies`: `Core safety policy files exist.`
- [`pass`] `Git context`: `2752 changed file(s) detected (105 non-evidence, 2647 AgentLoop evidence).`
