...
- Verification: `pass` - `.agentloop/reports/2026-06-22-22-19-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-22-22-21-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `26 non-evidence changed files is broad for one review; 39 AgentLoop evidence file(s) also present (65 total). Non-evidence review areas: Source 13, Documentation 8, Tests 4, AgentLoop 1.`
...
- Evidence map: `65` changed file(s); `26` covered, `0` unexplained; verification `fresh`; `0` risk-sensitive.
...
- AgentLoop evidence: `39` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
...
- [`pass`] `Git context`: `66 changed file(s) detected (26 non-evidence, 40 AgentLoop evidence).`
