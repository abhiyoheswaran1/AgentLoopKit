...
- Generated: `2026-06-21-05-33`
- Review readiness score: `92`/100
- Task: `Show AgentFlight session status in dogfood gate` (`in-progress`) - `.agentloop/tasks/2026-06-21-show-agentflight-session-status-in-dogfood-gate.md`
- Verification: `pass` - `.agentloop/reports/2026-06-21-05-32-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-21-05-33-pr-summary.md`
- Gates: `pass`
...
- `Scope control`: `45`/100 (weight `15`) - `89 non-evidence changed files is broad for one review; 284 AgentLoop evidence file(s) also present (373 total).`
...
- AgentLoop evidence: `284` file(s) grouped under `.agentloop/handoffs/`, `.agentloop/reports/`, `.agentloop/runs/`, `.agentloop/tasks/`, `.agentloop/tasks/archive/`.
- Full paths remain in JSON output and run-ledger evidence.

## Diff Stat

```text
.agentloop/backlog.md                         | 117 +++++++++
 .agentloop/harness/autonomous-dogfooding.md   |   3 +-
 ...
 tests/autonomous-dogfood.test.ts              |  18 ++
 ...
 tests/verification.test.ts                    |  43 ++++
 65 files changed, 1817 insertions(+), 216 deletions(-)
...
- [`pass`] `Task contract`: `Show AgentFlight session status in dogfood gate`
- [`pass`] `Verification report`: `Overall status: pass`
- [`pass`] `Handoff summary`: `Reviewer handoff found.`
- [`pass`] `Task hygiene`: `Task folder hygiene checks passed.`
- [`pass`] `Repo harness`: `Required repo and harness files exist.`
- [`pass`] `Safety policies`: `Core safety policy files exist.`
- [`pass`] `Git context`: `374 changed file(s) detected (89 non-evidence, 285 AgentLoop evidence).`
