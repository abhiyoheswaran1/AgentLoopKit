...
- Timestamp: `2026-06-16T06:46:34.791Z`
- Repo: `AgentLoopKit`
- Git branch: `main`
- Git commit: `a79cc41`
- Working tree: `dirty`
...
> vitest run tests/agent-installation.test.ts
 ...
 Test Files  1 passed (1)
      Tests  13 passed (13)
   Start at  08:46:35
   Duration  4.80s (transform 63ms, setup 0ms, import 106ms, tests 4.56s, environment 0ms)
...
> vitest run tests/agent-installation.test.ts tests/cli-docs-drift.test.ts
 ...
 Test Files  2 passed (2)
      Tests  14 passed (14)
   Start at  08:46:40
   Duration  5.62s (transform 97ms, setup 0ms, import 188ms, tests 6.04s, environment 0ms)
