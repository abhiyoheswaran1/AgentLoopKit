...
- Task: `Expose gate status through MCP` (`review`) - `.agentloop/tasks/2026-06-12-expose-gate-status-through-mcp.md`
- Verification: `pass` - `.agentloop/reports/2026-06-12-06-47-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-12-06-51-pr-summary.md`
- Gates: `pass`
...
- [`pass`] `Task contract`: `Expose gate status through MCP`
