...
- Task: `Clean stale root handoff release copy` (`done`) - `.agentloop/tasks/archive/2026-06-13-clean-stale-root-handoff-release-copy.md`
- Verification: `pass` - `.agentloop/reports/2026-06-13-10-20-verification-report.md`
- Handoff: `.agentloop/handoffs/2026-06-13-10-22-pr-summary.md`
- Gates: `pass`
...
- [`pass`] `Task contract`: `Clean stale root handoff release copy`
