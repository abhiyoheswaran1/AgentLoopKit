...
- GitHub release `v0.28.4` is public.
- npm latest is `agentloopkit@0.28.4`.
- GHCR and MCP Registry are live for `0.28.4`.
...
- Release tag `v0.28.4` points at the published release commit. Current `main` may include post-release bookkeeping.
