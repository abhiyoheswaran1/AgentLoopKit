...
- Read-only MCP server with `agentloop mcp-server` for status, tasks, policies, verification reports, ship reports, run summaries and details, file intent matches, and handoffs
