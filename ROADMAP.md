...
- GHCR and MCP Registry are live for `1.1.0`.
...
- Release tag `v1.1.0` points at the published release commit.
- Current `main` contains release proof documentation after `v1.1.0`.
