...
- GitHub release `v0.28.5` is public.
- npm latest is `agentloopkit@0.28.5`.
- GHCR and MCP Registry are live for `0.28.5`.
...
- Release tag `v0.28.5` points at the published release commit. Current `main` may include post-release bookkeeping.
