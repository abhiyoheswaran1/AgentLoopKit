...
- GHCR and MCP Registry are live for `0.34.1`.
...
- Release tag `v0.34.1` points at the published release commit.
- Published release commit: `c2f1ea76b77d12a2a865b01c98ecc248eac22afa`.
