...
Source on `main` documents `0.9.0`. npm currently serves `0.1.1` while publishing auth for later release candidates is being repaired. GitHub release tarballs contain the newer source commands.
