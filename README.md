...
npx --yes agentloopkit@0.26.5 init
```
...
See `docs/github-actions.md`, `examples/github-actions/`, `examples/gitlab-ci/`, and `examples/buildkite/` for copy-pasteable workflows. Pin `agentloopkit@0.26.5` or a newer vetted release when reproducibility matters.
