...
The tarball pin is temporary while npm latest is behind the GitHub release. After npm publishes `0.18.0`, replace the install step with `npm install --no-save agentloopkit@0.18.0` or an unpinned npm install.
